...
export function ToggleGroupDemo() {
	return (
		<div className='flex flex-col items-center gap-6 md:flex-row'>
			...
			<ToggleGroup variant='outline' type='single' size='sm' defaultValue='last-24-hours' className='*:data-[slot=toggle-group-item]:px-3'>
			...
			<ToggleGroup type='single' size='sm' defaultValue='last-24-hours' className='*:data-[slot=toggle-group-item]:px-3'>
				<ToggleGroupItem value='last-24-hours' aria-label='Toggle last 24 hours'>
					Last 24 hours
				</ToggleGroupItem>
				<ToggleGroupItem value='last-7-days' aria-label='Toggle last 7 days'>
